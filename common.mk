...
# git@github.com:oasisprotocol/metadata-registry-tools.git.
METADATA_REGISTRY_TOOLS_GIT_ORIGIN_REMOTE ?= origin

# Name of the branch where to tag the next release.
RELEASE_BRANCH ?= master

# Try to determine the tooling's version from git.
...
# Add the tooling version as a linker string value definition.
ifneq ($(VERSION),)
...
define CHECK_GITLINT =
	BRANCH=$(METADATA_REGISTRY_TOOLS_GIT_ORIGIN_REMOTE)/$(RELEASE_BRANCH); \
